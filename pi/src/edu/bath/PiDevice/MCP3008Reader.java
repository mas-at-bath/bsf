...
{
  private final static boolean DISPLAY_DIGIT = false;//.equals(System.getProperty("display.digit", "false"));
  ...
  private static Pin spiMiso = RaspiPin.GPIO_05; // Pin #23, data in.  MISO: Master In Slave Out
  private static Pin spiMosi = RaspiPin.GPIO_04; // Pin #24, data out. MOSI: Master Out Slave In
  ...
  public static void initMCP3008()
  {
    ...
    if (gpio != null)
        System.out.println("Opened gpio controller OK");
    else {
        //try again later if you want 
        System.out.print("Failed to get gpio controller");
