...
public class WorkerNonThreadMQTTSender extends Sensor {
	...
	public WorkerNonThreadMQTTSender(String serverAddress, String id, String password, String nodeName, String currentLocation, String primaryHandle) {
		super(serverAddress, id, password, nodeName, true, 0);
